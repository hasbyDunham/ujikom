                    ...
                    <form action="{{ route('pengumuman.update', $pengumuman->id) }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <textarea name="deskripsi_pengumuman" id="deskripsi" cols="30"
                                    rows="10">{{ $pengumuman->deskripsi_pengumuman }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <img src="{{ asset('storage/images/pengumuman/' . $pengumuman->foto) }}"
