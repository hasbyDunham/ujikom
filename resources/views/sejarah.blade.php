        ...
        <div class="container py-4">
            <div class="row g-5 d-flex align-items-start">
                ...
                <div class="col-lg-12 wow fadeInLeft d-flex flex-column text-center mx-auto" data-wow-delay="0.2s">
                    <div class="section-title mb-5">
                        <h1 class="display-6 mb-4">Sejarah Fakultas Ushuluddin</h1>
                        <p class="content-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Secara historis,
                            Fakultas Ushuluddin termasuk fakultas
                            yang
                            paling awal berdiri bersamaan dengan didirikannya UIN ( saat itu masih IAIN ) Sunan Gunung Djati
                            Bandung,
                        ...
                        <p class="content-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Setelah K.H. Anwar Musaddad, Dekan berikutnya adalah Drs. H. Farichin
                            Khumaidi,MA (almarhum).
