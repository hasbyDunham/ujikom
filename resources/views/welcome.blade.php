...
<body>
    ...
    @endphp
    @php
        $pengumuman = \App\Models\Pengumuman::where('flag', 'PUBLISHED')->orderBy('id', 'asc')->paginate(6);
        $beritaF = \App\Models\BeritaF::where('flag', 'PUBLISHED')->orderBy('id', 'asc')->paginate(6);
    @endphp
    <!-- Navbar & Hero Start -->
